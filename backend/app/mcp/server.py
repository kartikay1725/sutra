...
mcp_server = MCPServer(
    ...
    instructions=(
        ...
        "- 'list issues' / 'view backlog' / 'see bug tickets' -> sutra_list_issues\n"
        "- 'view discussions' / 'explore architectural decisions' -> sutra_list_discussions\n"
        "- 'participate in discussion' / 'reply to topic' -> sutra_comment_discussion\n"
        "- 'start discussion' / 'propose RFC' -> sutra_create_discussion\n"
        "- 'check CI logs' / 'why did build fail' / 'inspect test errors' -> sutra_get_ci_logs\n"
        "- 'read PR feedback' / 'get review comments' -> sutra_get_pr_comments\n"
        "- 'reply to review' / 'add inline PR comment' -> sutra_add_pr_comment\n"
