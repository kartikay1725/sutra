      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 32 }}>
        ...
        <section>
          ...
          <table className="table" style={{ margin: "16px 0" }}>
            ...
            <tbody>
              <tr>
                <td style={{ fontWeight: 700, color: "#0F172A" }}>Owner</td>
                <td>Full governance, deletion &amp; agent delegation</td>
                <td>Create, review, approve, resolve threads</td>
                <td style={{ color: "#2563EB", fontWeight: 700 }}>✓ Allowed</td>
              </tr>
              <tr>
                <td style={{ fontWeight: 700, color: "#2563EB" }}>Collaborator</td>
                <td>Read, branch &amp; push</td>
                <td>Create, comment &amp; review</td>
                <td style={{ color: "#2563EB", fontWeight: 700 }}>✓ When authorized</td>
              </tr>
              <tr>
                <td style={{ fontWeight: 700, color: "#EA580C" }}>AI Agent</td>
                <td>Bounded clone &amp; push to feature branch</td>
                <td>Create PR &amp; submit findings</td>
                <td style={{ color: "#DC2626", fontWeight: 700 }}>✕ Blocked</td>
              </tr>
            </tbody>
          </table>
        </section>
        ...
        <section>
          ...
          <table className="table" style={{ marginTop: 20 }}>
            ...
            <tbody>
              <tr>
                <td style={{ fontWeight: 700, color: "#0F172A" }}>Commit</td>
                <td>Git tree snapshot</td>
                <td style={{ fontFamily: "monospace", fontSize: 12, color: "#2563EB" }}>SHA, Author, Tree</td>
              </tr>
              <tr>
                <td style={{ fontWeight: 700, color: "#2563EB" }}>Change</td>
                <td>Abstract work block</td>
                <td style={{ fontFamily: "monospace", fontSize: 12, color: "#2563EB" }}>Additions, Deletions, File-diffs</td>
              </tr>
              <tr>
                <td style={{ fontWeight: 700, color: "#EA580C" }}>Pull Request</td>
                <td>Formal merge request</td>
                <td style={{ fontFamily: "monospace", fontSize: 12, color: "#2563EB" }}>Reviews, CI status, Approvals</td>
              </tr>
            </tbody>
          </table>
        </section>
        ...
        <section>
          ...
          <p style={{ color: "#334155", lineHeight: 1.7, marginBottom: 16 }}>
            Repository policies are configured per-repository under <code style={{ color: "#EA580C", background: "#FFF7ED", padding: "1px 5px", borderRadius: 4, border: "1px solid #FED7AA" }}>/repositories/[name]/settings</code>.
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: 14, marginTop: 16 }}>
            <div style={{ padding: 18, border: "1px solid #E2E8F0", borderRadius: 10, background: "#FFFFFF", boxShadow: "0 1px 3px rgba(0,0,0,0.04)" }}>
              <div style={{ display: "flex", alignItems: "center", gap: 8, color: "#EA580C", fontWeight: 700, marginBottom: 6 }}>
                <ShieldCheck size={16} />
                <span style={{ color: "#0F172A", fontWeight: 700 }}>Branch Protection Rules</span>
              </div>
              <p style={{ fontSize: 12.5, color: "#475569", lineHeight: 1.6, margin: 0 }}>
                Configure branch patterns (e.g. <code style={{ color: "#EA580C", background: "#FFF7ED", padding: "1px 4px", borderRadius: 3 }}>main</code>, <code style={{ color: "#EA580C", background: "#FFF7ED", padding: "1px 4px", borderRadius: 3 }}>release/*</code>) with required approval counts, mandatory passing CI status checks, and linear git history requirements.
              </p>
            </div>
            ...
            <div style={{ padding: 18, border: "1px solid #E2E8F0", borderRadius: 10, background: "#FFFFFF", boxShadow: "0 1px 3px rgba(0,0,0,0.04)" }}>
              <div style={{ display: "flex", alignItems: "center", gap: 8, color: "#2563EB", fontWeight: 700, marginBottom: 6 }}>
                ...
                <span style={{ color: "#0F172A", fontWeight: 700 }}>Human Merge Hand-off</span>
              </div>
              <p style={{ fontSize: 12.5, color: "#475569", lineHeight: 1.6, margin: 0 }}>
                AI agents can never bypass branch protection or merge their own pull requests. When ready, agents call <code style={{ color: "#EA580C", background: "#FFF7ED", padding: "1px 4px", borderRadius: 3 }}>sutra_request_merge</code> to transition the PR to a human approval queue.
              </p>
            </div>
            ...
            <div style={{ padding: 18, border: "1px solid #E2E8F0", borderRadius: 10, background: "#FFFFFF", boxShadow: "0 1px 3px rgba(0,0,0,0.04)" }}>
              <div style={{ display: "flex", alignItems: "center", gap: 8, color: "#EA580C", fontWeight: 700, marginBottom: 6 }}>
                <GitBranch size={16} />
                <span style={{ color: "#0F172A", fontWeight: 700 }}>Universal GitHub Synchronization</span>
              </div>
              <p style={{ fontSize: 12.5, color: "#475569", lineHeight: 1.6, margin: 0 }}>
                Repositories and upstream GitHub status are synchronized directly from the global Topbar sync button or the Repositories overview (<code style={{ color: "#EA580C", background: "#FFF7ED", padding: "1px 4px", borderRadius: 3 }}>/repositories</code>). Automatic 5-minute debouncing prevents API rate limits with optional Force Sync.
              </p>
            </div>
          </div>
        </section>
