...
export const Group7SecurityGovernance: DocSection[] = [
  { 
    ...
    toc: [
      { id: "security-model", label: "Security & Governance Model" },
      { id: "agent-boundaries", label: "Agent Boundaries & Enforcement" },
      { id: "four-pillars", label: "Four-Pillar Governance Engine" },
    ],
    content: (
      <div className="flex flex-col gap-10">
        <section>
          <DocsHeading id="security-model" level={2}>
            SUTRA Security & Governance Model
          </DocsHeading>
        ...
        <section>
          <DocsHeading id="agent-boundaries" level={2}>
          ...
          <table className="table mb-4">
            ...
            <tbody>
              <tr>
                <td className="font-mono text-orange-400 text-xs">Self-Approval</td>
                <td>AuthorizationService enforces reviewer_id != requester_id. Agents cannot self-approve.</td>
                <td>API returns 403 Forbidden.</td>
              </tr>
              <tr>
                <td className="font-mono text-orange-400 text-xs">Direct / Agent Merge</td>
              ...
              <tr>
                <td className="font-mono text-orange-400 text-xs">Stale Approval Bypass</td>
              ...
              <tr>
                <td className="font-mono text-orange-400 text-xs">Unauthorized Scope Access</td>
        ...
        <section>
          <DocsHeading id="four-pillars" level={2}>
            Four-Pillar Governance Engine
          </DocsHeading>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="p-4 border border-[var(--line)] rounded-lg bg-white/5">
              <strong className="text-blue-400 text-sm">3. Policy & Sensitive Files</strong>
            ...
            <div className="p-4 border border-[var(--line)] rounded-lg bg-white/5">
              <strong className="text-orange-400 text-sm">4. Human Review & Approvals</strong>
